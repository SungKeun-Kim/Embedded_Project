...
1. `.github/copilot-instructions.md` — 핀 맵(LQFP80), 하드웨어 구성, 핵심 제약사항
2. `docs/STM32G474MET6_LQFP80_핀맵.md` — 핀 할당 확인
...
- GPIO AF 번호는 반드시 G4 데이터시트(LQFP80 패키지) 기준 확인
- `include/config.h`의 핀 정의를 항상 참조하고 매직 넘버 금지
- LCD1602 (74HCT574 방법 C): DATA 버스 PB10~PB15 + CLK_LCD(PD0) + CLK_LED(PD1). 74HCT574 VCC=5V 필수.
