...
>
> - 고정 인덕턴스: L_BASE = 3.3µH || 3.9µH = **1.79µH** (근사)
> - LC_RELAY1(PC6) = L1 = **0.89µH** (1.5µH || 2.2µH, bit0)
> - LC_RELAY2(PC7) = L2 = **2.7µH** (bit1)
> - LC_RELAY3(PC8) = L3 = **4.7µH** (bit2)
> - LC_RELAY4(PC9) = L4 = **6.8µH** (bit3)
> - 총합: L_total = L_BASE + 선택 릴레이 합
> - 16가지 조합 범위: **1.79µH(0000) ~ 16.88µH(1111)**
> - 주요 타깃: 1.76µH≈1.79(0000), 2.64µH≈2.68(0001), 16.9µH≈16.88(1111)
...
```
고정 인덕턴스: L_BASE = 1.79µH (3.3||3.9)
l_combo 비트 = [bit3:L4=6.8µH][bit2:L3=4.7µH][bit1:L2=2.7µH][bit0:L1=0.89µH]

L_total = L_BASE + (bit0?0.89:0) + (bit1?2.7:0) + (bit2?4.7:0) + (bit3?6.8:0)

0000 =  1.79µH  ← 1.76µH 목표 근사 (기본)
0001 =  2.68µH  ← 2.64µH 목표 근사
0110 =  9.19µH
1111 = 16.88µH  ← 16.9µH 목표 근사
```
