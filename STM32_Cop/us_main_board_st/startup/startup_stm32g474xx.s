 ...
 * @brief STM32G474xx 벡터 테이블 및 리셋 핸들러 (GCC)
 *
 * Cortex-M4F, FPU 탑재, 170 MHz 동작, HRTIM 내장.
 */
...
.word _sidata       /* .data 초기값 Flash 주소 */
.word _sdata        /* .data RAM 시작 */
.word _edata        /* .data RAM 끝 */
.word _sbss         /* .bss 시작 */
.word _ebss         /* .bss 끝 */

/* ============================================================
   Reset_Handler — .data 복사, .bss 클리어, SystemInit, main 호출
   ============================================================ */
...
/* ============================================================
   Default_Handler — 미등록 인터럽트용 무한 루프
   ============================================================ */
...
/* ============================================================
   벡터 테이블 (.isr_vector 섹션 — 링커 스크립트에서 Flash 시작에 배치)
   STM32G474xx 인터럽트 벡터 (RM0440 참조)
   ============================================================ */
...
g_pfnVectors:
  ...
  .word RTC_TAMP_LSECSS_IRQHandler       /*  2: RTC Tamper, LSE CSS */
  ...
  .word USB_HP_IRQHandler                /* 19: USB HP */
  .word USB_LP_IRQHandler                /* 20: USB LP */
  ...
  .word TIM1_TRG_COM_TIM17_IRQHandler    /* 26: TIM1 Trigger COM / TIM17 */
  ...
  .word RTC_Alarm_IRQHandler             /* 41: RTC Alarm (EXTI) */
  .word USBWakeUp_IRQHandler             /* 42: USB Wakeup (EXTI) */
  .word TIM8_BRK_IRQHandler              /* 43: TIM8 Break */
  .word TIM8_UP_IRQHandler               /* 44: TIM8 Update */
  .word TIM8_TRG_COM_IRQHandler          /* 45: TIM8 Trigger COM */
  .word TIM8_CC_IRQHandler               /* 46: TIM8 Capture Compare */
  .word ADC3_IRQHandler                  /* 47: ADC3 */
  .word FMC_IRQHandler                   /* 48: FMC (Reserved on G474) */
  ...
  .word TIM7_DAC_IRQHandler              /* 55: TIM7 / DAC underrun */
  ...
  .word COMP1_2_3_IRQHandler             /* 64: COMP1/2/3 */
  .word COMP4_5_6_IRQHandler             /* 65: COMP4/5/6 */
  .word COMP7_IRQHandler                 /* 66: COMP7 */
  .word HRTIM1_Master_IRQHandler         /* 67: HRTIM Master */
  ...
  .word TIM20_TRG_COM_IRQHandler         /* 79: TIM20 Trigger/COM */
...
/* ============================================================
   약한(Weak) 기본 핸들러 선언 — 미구현 시 Default_Handler로 분기
   ============================================================ */
  .weak      NMI_Handler
