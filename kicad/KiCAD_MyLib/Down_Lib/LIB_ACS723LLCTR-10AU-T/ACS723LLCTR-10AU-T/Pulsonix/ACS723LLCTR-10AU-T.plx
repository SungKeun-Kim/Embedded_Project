...
//806086/240622/2.50/8/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "ACS723LLCTR-10AU-T" (originalName "ACS723LLCTR-10AU-T")
	...
	(compDef "ACS723LLCTR-10AU-T" (originalName "ACS723LLCTR-10AU-T") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "BW_SEL") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "ACS723LLCTR-10AU-T"))
		...
		(attr "Manufacturer_Part_Number" "ACS723LLCTR-10AU-T")
		(attr "Mouser Part Number" "250-723LLCTR10AUT")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Allegro-MicroSystems/ACS723LLCTR-10AU-T?qs=pUKx8fyJudBwQc%2FSh6J%2FyA%3D%3D")
		(attr "Arrow Part Number" "ACS723LLCTR-10AU-T")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/acs723llctr-10au-t/allegro-microsystems?region=europe")
		(attr "Description" "High Accuracy 5V Optimized Current Sensor IC")
		(attr "<Hyperlink>" "https://www.allegromicro.com/-/media/files/datasheets/acs723-datasheet.ashx")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "ACS723LLCTR-10AU-T.stp")
		(attr "<STEP Offsets>" "X=4.01;Y=-0.84;Z=-4.31")
